...
ESSBOptionsStructureHelper::panel_start('optin', 'optin-10', __('Automatically add opt-in form below content', 'essb'), __('Activate of this option will allow to include forms on posts or pages to get more subscribers.', 'essb'), 'fa21 fa fa-cogs', array("mode" => "switch", 'switch_id' => 'optin_content_activate', 'switch_on' => __('Yes', 'essb'), 'switch_off' => __('No', 'essb')));
