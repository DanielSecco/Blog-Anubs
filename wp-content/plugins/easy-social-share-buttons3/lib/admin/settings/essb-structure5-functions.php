...
ESSBOptionsStructureHelper::title('functions', 'functions', __('Share buttons on mobile devices', 'essb'), __('Easy Social Share Buttons for WordPress has advanced mobile display options to get a fully personalized mobile appearance. If you do not wish to do this by yourself you can set automatic configuration and plugin will do the job for you.', 'essb'), 'inner-row');
ESSBOptionsStructureHelper::field_func('functions', 'functions', 'essb5_functions_mode_choose_mobile', '', '');

ESSBOptionsStructureHelper::title('functions', 'functions', __('Plugin Mode', 'essb'), __('Easy Social Share Buttons for WordPress is all-in-one social media plugin for WordPress packed with lot of options. In case you do not plan to use all of them it is easy to deactivate (or activate back) functions you do not need. To do this use one of preset operation modes or set on custom and remove functions you do not use.', 'essb'), 'inner-row');
ESSBOptionsStructureHelper::field_func('functions', 'functions', 'essb5_functions_mode_choose', '', '');

ESSBOptionsStructureHelper::holder_start('functions', 'functions', '', 'essb-functions-holder');
...
ESSBOptionsStructureHelper::field_section_end_full_panels('functions', 'functions');
ESSBOptionsStructureHelper::panel_end('functions', 'functions');
ESSBOptionsStructureHelper::holder_end('functions', 'functions');

ESSBOptionsStructureHelper::panel_start('functions', 'functions', __('Developer Functions', 'essb'), __('Easy Social Share Buttons for WordPress has advanced actions and filters for various things. Using developer functions you can integrate some of them diretly inside plugin settings and avoid touching code (when possible).', 'essb'), 'fa21 fa fa-cogs', array("mode" => "toggle", 'state' => 'closed'));
ESSBOptionsStructureHelper::field_section_start_full_panels('functions', 'functions', 'lightgrey-bg');
...
ESSBOptionsStructureHelper::panel_start('functions', 'functions', __('Deactivate Plugin Functions on Specific Places', 'essb'), __('Deactivate functions of plugin on selected posts/pages only', 'essb'), 'fa21 fa fa-cogs', array("mode" => "toggle", 'state' => 'closed', "css_class" => "essb-auto-open"));
